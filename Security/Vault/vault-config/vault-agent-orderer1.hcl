auto_auth {
  method {
    type = "approle"
    config = {
      role_id_file_path = "/Vault/vault-creds/orderer1-role_roleid.txt"
      secret_id_file_path = "/Vault/vault-creds/orderer1-role_secretid.txt"
